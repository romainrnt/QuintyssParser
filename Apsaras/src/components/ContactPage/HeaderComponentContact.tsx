...
const HeaderComponentContact: React.FC = () => {
  return (
    <section className="relative w-full h-[585px] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 max-w-[1920px]">
        ...
        >
          Vous souhaitez entrer en contact avec nous afin de programmer l’un ou plusieurs de nos
          spectacles dans votre ville, votre théâtre, ou pour toute autre manifestation, veuillez
          remplir les informations via notre formulaire ci-dessous, ou envoyer nous un mail avec
          votre souhait et vos coordonnées.
        </div>
      </div>
    </section>
  );
...
export default HeaderComponentContact;
