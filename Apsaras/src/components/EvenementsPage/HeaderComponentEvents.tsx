...
const HeaderComponentEvents: React.FC = () => {
  return (
    <section className="relative w-full h-[585px] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 max-w-[1920px]">
        ...
        >
          Retrouver ci-dessous la liste des événements à venir et ce à travers le monde entier. Sed
...
export default HeaderComponentEvents;
